<template>
  <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
    style="margin:auto;background:#fff;display:block; position: fixed; left: 50%; top: 50%; margin-left: -100px; margin-top: -100px;"
    width="200px" height="200px" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid">
    <defs>
      <clipPath id="ldio-xrz0fybbw2h-cp" x="0" y="0" width="100" height="100">
    ...
    <g clip-path="url(#ldio-xrz0fybbw2h-cp)">
      <g>
        <g transform="translate(50 41)">
          <path
            ...
            <animateTransform attributeName="transform" type="rotate" keyTimes="0;1" values="0;360"
              dur="0.4807692307692307s" repeatCount="indefinite"></animateTransform>
          </path>
        </g>
        <animateTransform attributeName="transform" type="translate" keyTimes="0;1" values="0 0;0 75"
          dur="0.9615384615384615s" repeatCount="indefinite"></animateTransform>
      </g>
      <g>
